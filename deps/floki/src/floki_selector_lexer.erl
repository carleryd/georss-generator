...
yystate(26, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(26, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 58 ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
...
yystate(21, [45|Ics], Line, Tlen, _, _) ->
    yystate(21, Ics, Line, Tlen+1, 0, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(21, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(13, [45|Ics], Line, Tlen, _, _) ->
    yystate(17, Ics, Line, Tlen+1, 16, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(17, Ics, Line, Tlen+1, 16, Tlen);
...
yystate(7, [45|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line, Tlen+1, 16, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(3, Ics, Line, Tlen+1, 16, Tlen);
...
yystate(3, [45|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line, Tlen+1, 3, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(3, Ics, Line, Tlen+1, 3, Tlen);
